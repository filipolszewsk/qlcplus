    ...
    , m_widgets(widgets)
{
    ...
    m_treeWidget = m_ui->m_treeWidget;
    ...
    connect(buttonBox, &QDialogButtonBox::accepted, this, &VCMultiInputEditor::accept);
    connect(buttonBox, &QDialogButtonBox::rejected, this, &VCMultiInputEditor::reject);
