...
void VirtualConsole::initActions()
{
    ...
    m_editMultiInputEditorAction = new QAction(QIcon(":/edit.png"), tr("Edit External Input"), this);
    connect(m_editMultiInputEditorAction, SIGNAL(triggered(bool)), this, SLOT(slotEditMultiInputEditor()));
    ...
    m_editActionGroup->addAction(m_editMultiInputEditorAction);
...
void VirtualConsole::initMenuBar()
{
    ...
    m_editMenu->addAction(m_editMultiInputEditorAction);
    m_editMenu->addSeparator();
    ...
    m_toolbar->addAction(m_editMultiInputEditorAction);
    m_toolbar->addSeparator();
...
void VirtualConsole::updateCustomMenu()
{
    ...
    if (m_selectedWidgets.size() > 0)
    {
        ...
        {
            m_customMenu = new QMenu(m_editMenu);
            m_customMenu->setTitle(tr("External Input"));
            m_customMenu->addAction(m_editMultiInputEditorAction);
            m_editMenu->addMenu(m_customMenu);
        }
    }
    else
...
void VirtualConsole::updateActions()
{
    ...
    if (m_selectedWidgets.isEmpty() == true)
    {
        ...
        m_editMultiInputEditorAction->setEnabled(false);
    ...
    else
    {
        ...
        m_editMultiInputEditorAction->setEnabled(true);
...
void VirtualConsole::slotEditMultiInputEditor()
{
    if (m_selectedWidgets.isEmpty() == true)
        return;

    VCMultiInputEditor editor(this, m_selectedWidgets, m_doc->inputOutputMap()->grandMasterInputSource());
...
# VSCode Open Tabs
platforms/macos/CMakeLists.txt
engine/src/qlcfixturehead.h
engine/src/qlcfixturehead.cpp
engine/src/rgbalgorithm.h
qmlui/qml/fixturesfunctions/RGBMatrixEditor.qml
ui/src/rgbmatrixeditor.h
ui/src/rgbmatrixeditor.ui
ui/src/rgbmatrixeditor.cpp
resources/rgbscripts/waves.js
resources/rgbscripts/wavesoffset.js
resources/rgbscripts/wavesdelay.js
engine/src/rgbalgorithm.cpp
engine/src/rgbscriptscache.cpp
engine/test/rgbmatrix/rgbmatrix_test.h
engine/test/rgbalgorithm/rgbalgorithm_test.cpp
engine/test/rgbscript/rgbscript_test.cpp
engine/src/CMakeLists.txt
engine/src/rgbscript.h
engine/src/rgbscript.cpp
ui/src/virtualconsole/vcmatrixpresetselection.ui
ui/src/virtualconsole/vcmatrixpresetselection.h
ui/src/virtualconsole/vcmatrixproperties.ui
ui/src/virtualconsole/vcmatrixpresetselection.cpp
ui/src/virtualconsole/vcmatrixproperties.cpp
ui/src/virtualconsole/vcmatrixproperties.h
...
ui/src/virtualconsole/vcmatrixcontrol.h
ui/src/virtualconsole/vcmatrix.h
resources/rgbscripts/dynamic_params_test.js
readme_vcmultiple
CMakeLists.txt
main/CMakeLists.txt
qmlui/virtualconsole/VCAnimationProperties.qml
qmlui/virtualconsole/vcanimation.h
qmlui/virtualconsole/vcanimation.cpp
qmlui/CMakeLists.txt
qmlui/qmlui.pro
qmlui/qmlui.qrc
ui/src/virtualconsole/vcframepageshortcut.cpp
ui/src/virtualconsole/vcmultiinput.h
ui/src/virtualconsole/vcframepageshortcut.h
ui/src/virtualconsole/vcpropertieseditor.h
ui/src/virtualconsole/vcmultiinput.cpp
ui/src/virtualconsole/vcwidget.h
ui/src/virtualconsole/vcwidget.cpp
vcmultiput.md
ui/src/virtualconsole/virtualconsole.h
ui/src/virtualconsole/vccuelist.h
ui/src/virtualconsole/vcframe.h
ui/src/virtualconsole/vcxypad.h
ui/src/virtualconsole/vcxypad.cpp
ui/src/virtualconsole/vcslider.h
ui/src/virtualconsole/vcslider.cpp
ui/src/virtualconsole/vccuelist.cpp
ui/src/virtualconsole/vcframe.cpp
plugins/CMakeLists.txt
ui/src/virtualconsole/vcmultiinputeditor.ui
ui/src/virtualconsole/vcmultiinputeditor.h
ui/src/virtualconsole/vcmultiinputeditor.cpp
ui/src/CMakeLists.txt
ui/src/virtualconsole/virtualconsole.cpp

# Current Time
29/07/2025, 2:57:56 pm (Europe/Warsaw, UTC+2:00)

# Context Window Usage
119,117 / 128K tokens used (93%)
