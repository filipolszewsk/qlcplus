...
VirtualConsole::VirtualConsole(QWidget* parent, Doc* doc)
    ...
    , m_editMultiInputPropertiesAction(NULL)
...
void VirtualConsole::initActions()
{
    ...
    m_addMultiInputAction = new QAction(QIcon(":/multitrack.png"), tr("New Multi-Input"), this);
    connect(m_addMultiInputAction, SIGNAL(triggered(bool)), this, SLOT(slotAddMultiInput()), Qt::QueuedConnection);
    ...
    m_addActionGroup->addAction(m_addMultiInputAction);
    ...
    m_editMultiInputPropertiesAction = new QAction(QIcon(":/multitrack.png"), tr("Multi-Input Properties"), this);
    connect(m_editMultiInputPropertiesAction, SIGNAL(triggered(bool)), this, SLOT(slotEditMultiInputProperties()));
    ...
    m_editActionGroup->addAction(m_editMultiInputPropertiesAction);
...
void VirtualConsole::initMenuBar()
{
    ...
    m_addMenu->addAction(m_addMultiInputAction);
    ...
    m_editMenu->addAction(m_editMultiInputPropertiesAction);
    ...
    m_toolbar->addAction(m_addMultiInputAction);
    ...
    m_toolbar->addAction(m_editMultiInputPropertiesAction);
...
void VirtualConsole::updateActions()
{
    ...
    if (m_selectedWidgets.isEmpty() == true)
    {
        ...
        m_editMultiInputPropertiesAction->setEnabled(false);
    ...
    else
    {
        ...
        m_editMultiInputPropertiesAction->setEnabled(true);
...
void VirtualConsole::slotAddMultiInput()
{
    VCWidget* parent(closestParent());
    if (parent == NULL)
        return;
...
void VirtualConsole::slotEditMultiInputProperties()
{
    VCWidget* widget;
    ...
    if (widget != NULL)
    {
        VCMultiInputEditor* editor = new VCMultiInputEditor(m_selectedWidgets, this);
