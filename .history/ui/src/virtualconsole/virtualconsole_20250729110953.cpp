...
VirtualConsole::VirtualConsole(QWidget* parent, Doc* doc)
    ...
    , m_editMultiInputPropertieAction(NULL)
...
void VirtualConsole::initActions()
{
    ...
    m_editMultiInputPropertieAction = new QAction(QIcon(":/edit.png"), tr("Multi-Input Propertie"), this);
    connect(m_editMultiInputPropertieAction, SIGNAL(triggered(bool)), this, SLOT(slotMultiInputProperties()));
    ...
    m_editActionGroup->addAction(m_editMultiInputPropertieAction);
...
void VirtualConsole::initMenuBar()
{
    ...
    m_editMenu->addAction(m_editMultiInputPropertieAction);
    ...
    m_toolbar->addAction(m_editMultiInputPropertieAction);
...
void VirtualConsole::updateActions()
{
    ...
    if (m_selectedWidgets.isEmpty() == true)
    {
        ...
        m_editMultiInputPropertieAction->setEnabled(false);
    ...
    else
    {
        ...
        m_editMultiInputPropertieAction->setEnabled(true);
...
void VirtualConsole::slotMultiInputProperties()
{
    VCWidget* widget;
