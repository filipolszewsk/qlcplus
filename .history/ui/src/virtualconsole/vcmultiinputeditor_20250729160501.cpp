    ...
    , m_widgets(widgets)
{
    ...
    connect(m_ui->buttonBox, &QDialogButtonBox::accepted, this, &VCMultiInputEditor::accept);
    connect(m_ui->buttonBox, &QDialogButtonBox::rejected, this, &VCMultiInputEditor::reject);
