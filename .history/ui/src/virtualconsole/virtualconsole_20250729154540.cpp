...
void VirtualConsole::initActions()
{
    ...
    m_multiEditAction = new QAction(QIcon(":/edit.png"), tr("Multiple edit"), this);
    connect(m_multiEditAction, SIGNAL(triggered(bool)), this, SLOT(slotMultiEdit()));
    ...
    m_editActionGroup->addAction(m_multiEditAction);
...
void VirtualConsole::initMenuBar()
{
    ...
    m_toolbar->addAction(m_multiEditAction);
...
void VirtualConsole::updateActions()
{
    ...
    if (m_selectedWidgets.isEmpty() == true)
    {
        ...
        m_multiEditAction->setEnabled(false);
    ...
    else
    {
        ...
        m_multiEditAction->setEnabled(m_selectedWidgets.size() > 1);
...
void VirtualConsole::slotMultiEdit()
{
    if (m_selectedWidgets.size() < 2)
        return;
