    ...
    , m_widgets(widgets)
{
    ...
    connect(m_buttonBox, &QDialogButtonBox::accepted, this, &VCMultiInputEditor::accept);
    connect(m_buttonBox, &QDialogButtonBox::rejected, this, &VCMultiInputEditor::reject);
