...
private:
    ...
    void stepIndexOutputUpdateFixtures();
    void stepIndexOutputSelectChannel(quint32 fixtureId, quint32 channel);
    void stepIndexOutputGetSelectedChannel(quint32 &fixtureId, quint32 &channel);
    quint32 m_chaserId;
};
