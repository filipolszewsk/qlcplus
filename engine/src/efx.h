...
public:
    ...
    /** Set mode for a specific column in fixture group mode */
    void setColumnMode(int column, int mode);
    
    /** Get mode for a specific column (returns 0 = PanTilt if not set) */
    int columnMode(int column) const;
