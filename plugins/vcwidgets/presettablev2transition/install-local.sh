...
DYLIB="${BUILD_DIR}/libpresettablev2transition_vcwidget.dylib"
...
"$FIX" "$DYLIB"
echo "Install Preset Table v2 first, then restart ~/QLC+.app"
echo "VC → Add → Preset Table v2 Transition"
